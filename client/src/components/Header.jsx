...
const Header = () => {
    ...
    return (
     ...
     className='flex flex-col justify-center items-center text-center my-20'>
        ...
        className='text-4xl max-w-[300px] sm:text-7xl sm:max-w-[590px] mx-auto mt-10 text -center'>Turn Texts To <span className='text-blue-600'>Image</span> In Seconds...</motion.h1>
